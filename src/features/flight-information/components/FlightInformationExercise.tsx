...
const FlightInformationExercise = () => {
  ...
  const currentScenario =
    scenarios.length > 0 && currentIndex >= 0 && currentIndex < scenarios.length
        ...
        <Card className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Configure how many flight passages you want to practice with, then
              press <strong>Start</strong>. For each passage, read the briefing
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="flex flex-col space-y-1">
              <label className="text-sm font-medium">Number of passages</label>
              <Input
                type="number"
                min={1}
                max={20}
            ...
            <div className="flex flex-col space-y-1">
              <label className="text-sm font-medium">Computation focus</label>
              <Select
                value={config.mode}
                onChange={(e) =>
                  setConfig((prev) => ({
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Read the passage carefully once, then answer from memory.
                  </p>
                </div>
                    ...
                    return (
                      <div key={key} className="flex flex-col space-y-1">
                        ...
                        {showReveal && (
                          <p className="text-xs text-muted-foreground">
                            Correct answer:{" "}
                            <code className="font-semibold">{expected}</code>
                          </p>
                        )}
                      </div>
                    );
